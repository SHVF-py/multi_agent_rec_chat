 ...
 *
 * STATES
 *   ready   — products indexed, normal chat button
 *   setup   — site key exists but no sync yet; pulsing button + badge
 *   syncing — sync job is running; spinner ring on button
 *
 * Usage:
...
(function () {
  ...
  if (!SITE_KEY) {
    console.warn("[Quiribot] No data-site-key provided — widget disabled.");
    return;
  }
  ...
  function injectWidget() {
    ...
    window.addEventListener("message", function (e) {
      ...
      // Chat.js tells us sync completed — update button to ready state
